...
TOOLS = [
    _function_tool("bash", "Run a shell command in the current workspace.", {"command": {"type": "string"}}, ["command"]),
    _function_tool("read_file", "Read file contents.", {"path": {"type": "string"}, "limit": {"type": "integer"}}, ["path"]),
    _function_tool("write_file", "Write content to file.", {"path": {"type": "string"}, "content": {"type": "string"}}, ["path", "content"]),
    _function_tool("edit_file", "Replace exact text in file.", {"path": {"type": "string"}, "old_text": {"type": "string"}, "new_text": {"type": "string"}}, ["path", "old_text", "new_text"]),
    _function_tool("task_create", "Create a new task on the shared task board.", {"subject": {"type": "string"}, "description": {"type": "string"}}, ["subject"]),
    _function_tool("task_list", "List all tasks with status, owner, and worktree binding.", {}),
    _function_tool("task_get", "Get task details by ID.", {"task_id": {"type": "integer"}}, ["task_id"]),
    _function_tool("task_update", "Update task status or owner.", {"task_id": {"type": "integer"}, "status": {"type": "string", "enum": ["pending", "in_progress", "completed", "deleted"]}, "owner": {"type": "string"}}, ["task_id"]),
    _function_tool("task_bind_worktree", "Bind a task to a worktree name.", {"task_id": {"type": "integer"}, "worktree": {"type": "string"}, "owner": {"type": "string"}}, ["task_id", "worktree"]),
    _function_tool("worktree_create", "Create a git worktree and optionally bind it to a task.", {"name": {"type": "string"}, "task_id": {"type": "integer"}, "base_ref": {"type": "string"}}, ["name"]),
    _function_tool("worktree_list", "List worktrees tracked in .worktrees/index.json.", {}),
    _function_tool("worktree_enter", "Enter or reopen a worktree lane before working in it.", {"name": {"type": "string"}}, ["name"]),
    _function_tool("worktree_status", "Show git status for one worktree.", {"name": {"type": "string"}}, ["name"]),
    _function_tool("worktree_run", "Run a shell command in a named worktree directory.", {"name": {"type": "string"}, "command": {"type": "string"}}, ["name", "command"]),
    _function_tool("worktree_closeout", "Close out a lane by keeping it for follow-up or removing it.", {"name": {"type": "string"}, "action": {"type": "string", "enum": ["keep", "remove"]}, "reason": {"type": "string"}, "force": {"type": "boolean"}, "complete_task": {"type": "boolean"}}, ["name", "action"]),
    _function_tool("worktree_remove", "Remove a worktree and optionally mark its bound task completed.", {"name": {"type": "string"}, "force": {"type": "boolean"}, "complete_task": {"type": "boolean"}, "reason": {"type": "string"}}, ["name"]),
    _function_tool("worktree_keep", "Mark a worktree as kept without removing it.", {"name": {"type": "string"}}, ["name"]),
    _function_tool("worktree_events", "List recent lifecycle events.", {"limit": {"type": "integer"}}),
]
